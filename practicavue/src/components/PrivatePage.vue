<template>
  ...
  export default {
    ...
    methods: {
      async fetchUsers() {
        try {
          const response = await AxiosRequest("/usuarios_private/private/usuarios", "R");
      ...
      async createUser() {
        try {
          await AxiosRequest("/usuarios_private/private/usuarios", "C", this.newUser);
          this.fetchUsers();
      ...
      async deleteUser(user) {
        try {
          await AxiosRequest(`/usuarios_private/private/usuarios/${user.id}`, "D");
          this.fetchUsers();
        } catch (error) {
      ...
      async changeState(user) {
        try {
          await AxiosRequest(`/usuarios_private/private/usuarios/${user.id}/state`, "P");
          this.fetchUsers();
        } catch (error) {

...
export default {
  ...
  // Este ciclo de vida se ejecuta una vez que el componente ha sido completamente renderizado y añadido al DOM.
  // Es el momento ideal para realizar tareas que dependen de que el componente esté en el DOM.
  mounted() {
    this.updateTime();
    setInterval(this.updateTime, 1000); // 1000ms = 1 segundo
  },
